...
public class GameTableViewCell: UITableViewCell {
    public static let name: String = String(describing: GameTableViewCell.self)
    ...
    private func setupConstraint() {
        ...
        nameLabel.heightAnchor.constraint(greaterThanOrEqualToConstant: 38)
            .isActive = true
        ...
        NSLayoutConstraint.activate([
            ...
            centerContainerView.topAnchor.constraint(
                equalTo: containerView.topAnchor,
                constant: 6
            ),
            centerContainerView.bottomAnchor.constraint(
        ...
        NSLayoutConstraint.activate([
            ratingContainerView.leadingAnchor.constraint(
                equalTo: centerContainerView.trailingAnchor,
                constant: 10
            ),
            ratingContainerView.trailingAnchor.constraint(
            ...
            ratingContainerView.centerYAnchor.constraint(
        ...
        NSLayoutConstraint.activate([
            ratingLabel.leadingAnchor.constraint(
                equalTo: ratingContainerView.leadingAnchor,
                constant: 5
            ),
            ratingLabel.trailingAnchor.constraint(
                equalTo: ratingContainerView.trailingAnchor,
                constant: -5
            ),
            ratingLabel.centerYAnchor.constraint(
                equalTo: ratingContainerView.centerYAnchor
            ),
        ])
    }
    ...
    public func configure(
        ...
        let platforms: [Platform] = platformNames.compactMap {
            Platform(rawValue: $0)
        }
